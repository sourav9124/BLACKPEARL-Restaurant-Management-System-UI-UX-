...
class User
{
	...
	private function emailExists($email)
	{
		...
		$pre_stmt->execute() or die($pre_stmt->con->error);
	...
	{
		//To protect from sql attack we are using prepared statement
...
//$user=new User();
 //$user->createUserAccount("sourav","sourav@gmail.com","123","Admin");
 // $user->UserLogin("a@gmail.com","123");
